...
if __name__ == "__main__":
    ...
    # BPNN
    bp = MLPRegressor(hidden_layer_sizes=(15,), random_state=5, learning_rate_init=0.1)
    bp.fit(x_train_Standard, labelset)
    train_out = bp.predict(x_train_Standard)
    test_out = bp.predict(x_test_Standard)
    ...
    # writer = pd.ExcelWriter('GMDH.xlsx')
