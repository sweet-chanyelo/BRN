...
def brb(p, input):
    ...
    feature1 = [45, 60, 70, 82]
    feature2 = [0.2, 0.6, 1, 1.21]
...
if __name__ == '__main__':
    N = 82
    ga = GA(func=demo_func, n_dim=N, size_pop=50, max_iter=300, lb=np.zeros(N), ub=np.ones(N), precision=1e-7)
...
# -----------------运行-----------------------------------------------------------------------------------%#
    ...
    # writer = pd.ExcelWriter('BRB8.xlsx')
