...
def brb(p, input):
    ...
    feature1 = [45, 50, 60, 82]
    feature2 = [14.04, 15, 16, 16.27]
...
if __name__ == '__main__':
    N = 82
    ga = GA(func=demo_func, n_dim=N, size_pop=50, max_iter=200, lb=np.zeros(N), ub=np.ones(N), precision=1e-7)
...
# -----------------运行-----------------------------------------------------------------------------------%#
    ...
    # writer = pd.ExcelWriter('BRB7.xlsx')
